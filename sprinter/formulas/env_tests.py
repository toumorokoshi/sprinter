...
class TestEnvFormula(FormulaTest):
    ...
    def test_simple_example(self):
        ...
        self.environment.directory.add_to_rc.assert_has_call("export USER=toumorokoshi")
        self.environment.directory.add_to_rc.assert_has_call("export MAVEN_HOME=~/bin/mvn")
        self.environment.directory.add_to_rc.assert_has_call("export user=toumorokoshi")
        self.environment.directory.add_to_rc.assert_has_call("export user=toumorokoshi")
